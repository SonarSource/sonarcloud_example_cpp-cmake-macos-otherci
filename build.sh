...
SONAR_PROJECT_KEY=sonarcloud_example_cpp-cmake-macos-otherci # project name from SonarCloud projet creation page -Dsonar.projectKey=XXXX
SONAR_PROJECT_NAME=sonarcloud_example_cpp-cmake-macos-otherci # project name from SonarCloud projet creation page -Dsonar.projectName=XXXX
